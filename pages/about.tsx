	  ...
	  <Head>
		...
		<div className="container h-screen">
			...
			<div className="text-xl font-normal">
				...
				<br/>
				<p>
					In March 2020, Jaclyn&apos;s daughter was born and the pandemic hit. She decided to leave elementary education and set out to follow her dreams of becoming a yoga teacher and balancing the stay-at-home-mom life. Jaclyn has since completed her 200 & 300 HR YTT through Uplifted Yoga with Brett Larkin and an 85-hour prenatal yoga course with Shanti Mom Yoga while being pregnant with her second daughter. Jaclyn loves to learn, teach, and connect with her students. She is in the thick of motherhood herself and has developed a passion for providing moms with a safe, supportive space to relax and connect with themselves, baby, and other mamas.
				</p>
			</div>
			...
			<section>
				<div>
					<h3 className="text-center text-2xl text-primary-content p-10">Check Out Her Class Schedule</h3>
				</div>
				<div className="grid justify-items-center">
					<Link href="/schedule">
						<button className="btn btn-active btn-accent">See Schedule</button>
					</Link>
				</div>
			</section>
		</div>
